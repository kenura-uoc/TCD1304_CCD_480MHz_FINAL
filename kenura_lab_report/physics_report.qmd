...
::: {.callout-note}
### Why the Error Bars Are Smaller in the Dual-Output Models
A notable observation across both the PLS and 1D CNN dual-output models (@fig-premium-eval, @fig-cnn-real-eval) is that the per-sample error bars ($1\sigma$ across repeated CV) are markedly smaller than those seen in the Phase 1 single-analyte models. Three factors explain this:
