...
| :--- | :---: | :---: | :---: | :---: |
| **PLS (20-fold CV)** | 0.871 | 0.834 | 1.45 mg/L | 1.12 mg/L |
| **1D CNN (5-fold CV)** | 0.820 | 0.860 | 1.55 mg/L | 0.90 mg/L |

: Comparison of PLS and 1D CNN on collected real-world spectra (n = 79). {#tbl-pls-cnn-real}
...
![1D CNN dual-output evaluation on real-world spinach-extract samples. The model captures the combined concentration trends despite limited training data.](images/real_data_cnn_evaluation.png){#fig-cnn-real-eval}
