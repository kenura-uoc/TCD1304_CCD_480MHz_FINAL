...
-   **Dynamic Range**: Aim for a peak intensity of **3000 - 3500 counts** (on a 12-bit sensor). This maximizes Signal-to-Noise Ratio (SNR) while staying in the linear region of the CCD.
-   **Avoiding Saturation**: Never exceed 3800 counts. Non-linearity increases rapidly near saturation.
...
-   **Spacing**: Do not just dilute by half each time. Use a mix of:
    -   **Linear spacing** (e.g., 1, 2, 3, 4, 5 ppm)
    -   **Log spacing** for low concentrations (e.g., 0.01, 0.05, 0.1, 0.2 ppm)
